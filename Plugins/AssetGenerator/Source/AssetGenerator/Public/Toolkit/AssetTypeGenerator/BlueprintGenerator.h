...
public:
	...
	static bool CreateBlueprintVariablesForProperties(UBlueprint* Blueprint, const TArray<UDeserializedProperty>& Properties, const TMap<FName, FDeserializedFunction>& Functions, const TFunctionRef<bool(const UDeserializedProperty& Property)>& PropertyFilter);
