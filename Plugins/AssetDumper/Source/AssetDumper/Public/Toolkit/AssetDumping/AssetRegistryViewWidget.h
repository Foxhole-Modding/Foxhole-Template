...
class ASSETDUMPER_API SAssetRegistryViewWidget : public SCompoundWidget {
public:
...
class ASSETDUMPER_API SAssetTreeNodeRow : public SMultiColumnTableRow<TSharedPtr<FAssetTreeNode>> {
