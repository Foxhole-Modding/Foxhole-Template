...
#include "UObject/NoExportTypes.h"
#include "MultiLauncherVehicle.generated.h"

class USkeletalMeshComponent;

UCLASS(Blueprintable)
class WAR_API AMultiLauncherVehicle : public ARWDSimVehicle, public IGunnerSupport {
    GENERATED_BODY()
public:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Replicated, meta=(AllowPrivateAccess=true))
    FVector2D GunnerYawAndPitch;
    
    UPROPERTY(EditAnywhere, SaveGame, ReplicatedUsing=OnRep_StashedAmmo)
    uint8 StashedAmmo;
